/**
 * We rebuild article enhancements
 */

class WeRebuildArticle {
  
  constructor() {
    this.article = document.querySelector("article.story-body");
    this.replaceKicker();
  }

  replaceKicker() {
    let kicker = this.article.querySelector(".header .kicker");
    kicker.innerHTML = `
<style>
  .kicker {
    border: none;
...
<svg id="We_Rebuild" data-name="We Rebuild" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 518.3 201.2" height="60">
